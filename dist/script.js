...
window.addEventListener('DOMContentLoaded', function () {
  "use strict"; // state of modal where user does inputs and checks

  var modalState = {}; // always transforming due to changeModalState function

  var deadline = '2023-12-01';
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); // only with tags div

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block'); // only with tags 'img'

  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); //sending current state 
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input'); // getting all inpust with field 'user_phone'
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            document.querySelector('.status').textContent = messsage.loading; // letting know to JS to wait result ('res') first coz fetch() is asynchronous...and then continue 
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (event) {
      event.preventDefault();
      var statusMassage = document.createElement('div'); //adding class 'status

      statusMassage.classList.add('status'); //appending 'div' into the end of form

      item.appendChild(statusMassage); // this new object will find all inputs in the current form (item)

      var formData = new FormData(item); // checking for specific modal window needed (with our custom data atr.)
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return statusMassage.textContent = messsage.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); // watching for whole area with tabs

  header.addEventListener('click', function (e) {
    var target = e.target; //checking if click appeared exactly on tab
    ...
    if (target && (target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
      tab.forEach(function (item, i) {
        if (target == item || target.parentNode == item) {
          hideTabContent();
          showTabContent(i);
        } //checking if clicked tab inside of selected tabs area
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      ...
      days.textContent = addZero(t.days); // will be written into block on the screen
      ...
      if (t.total <= 0) {
        days.textContent = "00"; // will be written into block on the screen
